...
public class Passenger implements Comparable<Passenger>{
    ...
    public Passenger(String passengerId,String name){
        ...
        this.gender="";
        this.age=0;
        this.siblingsAndSpouses=0;
        this.parentsAndChildren=0;
        this.ticketNumber="";
        this.fare=0;
        this.cabin="";
        this.embarkedAt="";
    ...
    public int compareTo(Passenger passenger) {
      return this.passengerId.compareTo(passenger.passengerId);
    }
    // STATIC Comparators

    public static int compareByTicketNumber(Passenger p1, Passenger p2) {
        return p1.ticketNumber.compareTo(p2.ticketNumber);
    }
